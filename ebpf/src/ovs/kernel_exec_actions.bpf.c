...
DEFINE_HOOK(
    F_AND, RETIS_F_PACKET_PASS, u32 queue_id; u64 tid = bpf_get_current_pid_tgid(); struct execute_actions_ctx ectx = {}; struct sk_buff * skb;
    ...
    if (!bpf_map_update_elem(&inflight_exec, &tid, &ectx, BPF_ANY)) return 0;
